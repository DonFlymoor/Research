...
singleton Material("etk800.skin.brushedtrim")
{
   mapTo = "etk800.skin.brushedtrim";
    diffuseMap[2] = "vehicles/etk800/etk800_c.dds";
    specularMap[2] = "vehicles/etk800/etk800_s.dds";
    normalMap[2] = "vehicles/etk800/etk800_n.dds";
    diffuseMap[1] = "vehicles/etk800/etk800_d_alt.dds";
    specularMap[1] = "vehicles/etk800/etk800_s.dds";
    normalMap[1] = "vehicles/etk800/etk800_n.dds";
    diffuseMap[0] = "vehicles/common/null.dds";
    specularMap[0] = "vehicles/common/null.dds";
...
singleton Material("etk800.skin.polizei")
{
   mapTo = "etk800.skin.polizei";
    overlayMap[2] = "vehicles/etk800/etk800_skin_polizei.dds";
    diffuseMap[2] = "vehicles/etk800/etk800_c.dds";
    specularMap[2] = "vehicles/etk800/etk800_s.dds";
    normalMap[2] = "vehicles/etk800/etk800_n.dds";
    diffuseMap[1] = "vehicles/etk800/etk800_d.dds";
...
singleton Material("etk800.skin.drivingexperience")
{
   mapTo = "etk800.skin.drivingexperience";
    overlayMap[2] = "vehicles/etk800/etk800_skin_drivingexperience.dds";
    diffuseMap[2] = "vehicles/etk800/etk800_c.dds";
    specularMap[2] = "vehicles/etk800/etk800_s.dds";
    normalMap[2] = "vehicles/etk800/etk800_n.dds";
    diffuseMap[1] = "vehicles/etk800/etk800_d.dds";
...
singleton Material("etk800_seats.skin_interior.ttsport")
{
    mapTo = "etk800_seats.skin_interior.ttsport";
    normalMap[0] = "vehicles/etk800/etk800_seats_n.dds";
    diffuseMap[0] = "vehicles/etk800/etk800_seats_d_ttsport.dds";
    specularMap[0] = "vehicles/etk800/etk800_seats_s.dds";
    diffuseColor[0] = "1 1 1 1";
    specularPower[0] = "32";
    useAnisotropic[0] = "1";
...
singleton Material("etk800_interior.skin_interior.ttsport")
{
    mapTo = "etk800_interior.skin_interior.ttsport";
    normalMap[0] = "vehicles/etk800/etk800_interior_n.dds";
    diffuseMap[0] = "vehicles/etk800/etk800_interior_d_ttsport.dds";
    specularMap[0] = "vehicles/etk800/etk800_interior_s.dds";
    diffuseColor[0] = "1 1 1 1";
    specularPower[0] = "32";
    useAnisotropic[0] = "1";
...
singleton Material("etk800_gauges.skin_gauges.metric")
{
    mapTo = "etk800_gauges.skin_gauges.metric";
    diffuseMap[0] = "vehicles/etk800/etk800_gauges_d.dds";
    specularMap[0] = "vehicles/etk800/etk800_gauges_s.dds";
    normalMap[0] = "vehicles/etk800/etk800_gauges_n.dds";
...
singleton Material("etk800_gauges_on.skin_gauges.metric")
{
    mapTo = "etk800_gauges_on.skin_gauges.metric";
    diffuseMap[1] = "vehicles/etk800/etk800_gauges_g.dds";
    specularMap[1] = "vehicles/etk800/etk800_gauges_s.dds";
    normalMap[1] = "vehicles/etk800/etk800_gauges_n.dds";
    diffuseMap[0] = "vehicles/etk800/etk800_gauges_d.dds";
...
singleton Material("etk800_gauges.skin_gauges.imperial")
{
    mapTo = "etk800_gauges.skin_gauges.imperial";
    diffuseMap[0] = "vehicles/etk800/etk800_gauges_d_alt.dds";
    specularMap[0] = "vehicles/etk800/etk800_gauges_s.dds";
    normalMap[0] = "vehicles/etk800/etk800_gauges_n.dds";
    diffuseColor[0] = "1.5 1.5 1.5 1";
    specularPower[0] = "32";
...
singleton Material("etk800_gauges_on.skin_gauges.imperial")
{
    mapTo = "etk800_gauges_on.skin_gauges.imperial";
    diffuseMap[1] = "vehicles/etk800/etk800_gauges_g_alt.dds";
    specularMap[1] = "vehicles/etk800/etk800_gauges_s.dds";
    normalMap[1] = "vehicles/etk800/etk800_gauges_n.dds";
    diffuseMap[0] = "vehicles/etk800/etk800_gauges_d_alt.dds";
    specularMap[0] = "vehicles/etk800/etk800_gauges_s.dds";
...
singleton Material("etk800_gauges.skin_gauges.metric_diesel")
{
    mapTo = "etk800_gauges.skin_gauges.metric_diesel";
    diffuseMap[0] = "vehicles/etk800/etk800_gauges_d_metric_diesel.dds";
    specularMap[0] = "vehicles/etk800/etk800_gauges_s.dds";
    normalMap[0] = "vehicles/etk800/etk800_gauges_n.dds";
    diffuseColor[0] = "1.5 1.5 1.5 1";
    specularPower[0] = "32";
...
singleton Material("etk800_gauges_on.skin_gauges.metric_diesel")
{
    mapTo = "etk800_gauges_on.skin_gauges.metric_diesel";
    diffuseMap[1] = "vehicles/etk800/etk800_gauges_g_metric_diesel.dds";
    specularMap[1] = "vehicles/etk800/etk800_gauges_s.dds";
    normalMap[1] = "vehicles/etk800/etk800_gauges_n.dds";
    diffuseMap[0] = "vehicles/etk800/etk800_gauges_d_metric_diesel.dds";
    specularMap[0] = "vehicles/etk800/etk800_gauges_s.dds";
...
singleton Material("etk800_gauges.skin_gauges.imperial_diesel")
{
    mapTo = "etk800_gauges.skin_gauges.imperial_diesel";
    diffuseMap[0] = "vehicles/etk800/etk800_gauges_d_imperial_diesel.dds";
    specularMap[0] = "vehicles/etk800/etk800_gauges_s.dds";
    normalMap[0] = "vehicles/etk800/etk800_gauges_n.dds";
    diffuseColor[0] = "1.5 1.5 1.5 1";
    specularPower[0] = "32";
...
singleton Material("etk800_gauges_on.skin_gauges.imperial_diesel")
{
    mapTo = "etk800_gauges_on.skin_gauges.imperial_diesel";
    diffuseMap[1] = "vehicles/etk800/etk800_gauges_g_imperial_diesel.dds";
    specularMap[1] = "vehicles/etk800/etk800_gauges_s.dds";
    normalMap[1] = "vehicles/etk800/etk800_gauges_n.dds";
    diffuseMap[0] = "vehicles/etk800/etk800_gauges_d_imperial_diesel.dds";
    specularMap[0] = "vehicles/etk800/etk800_gauges_s.dds";
