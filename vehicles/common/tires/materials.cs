...
singleton Material(offroadtire_03a)
{
    mapTo = "offroadtire_03";
    diffuseMap[1] = "vehicles/common/tires/offroadtire_03_d.dds";
    specularMap[1] = "vehicles/common/tires/offroadtire_03_s.dds";
    normalMap[1] = "vehicles/common/tires/offroadtire_03_n.dds";
    diffuseMap[0] = "vehicles/common/null.dds";
    specularMap[0] = "vehicles/common/null.dds";
    normalMap[0] = "vehicles/common/tires/offroadtire_03_n.dds";
    specularPower[0] = "16";
    pixelSpecular[0] = "1";
    specularPower[1] = "16";
    pixelSpecular[1] = "1";
