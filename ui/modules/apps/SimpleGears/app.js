angular.module('beamng.apps')
  .directive('simpleGears', ['$log', 'StreamsManager', function ($log, StreamsManager) {
    return {
      template:
      ...
      '<small style="color: rgba(255, 255, 255, 0.8); font-size: 0.75em">Gears ({{ gearboxType | uppercase }})</small>' +
      '</div>',
      replace: true,
      restrict: 'EA',
