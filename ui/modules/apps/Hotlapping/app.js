...
.directive('hotlapping', ['$filter', '$log', 'bngApi','$interval', function ($filter, $log, bngApi, $interval) {
  return {
    templateUrl: 'modules/apps/Hotlapping/app.html',
    replace: true,
    restrict: 'EA',
    scope: true,
    link: function (scope, element, $mdDialog)  {
        ...
        scope.times.detail = [];
        scope.times.best = {lap:'Best Lap', duration:'', diff:'', diffColor:''};
