...
**/
.controller('AutomationController',  ['$scope', '$location', 'bngApi', '$state', '$timeout', 'AutomationFilter', '$sce', '$sanitize', 'Utils', 'AutomationCategories',
  function($scope, $location, bngApi, $state, $timeout, AutomationFilter, $sce, $sanitize, Utils, AutomationCategories) {
  var vm = this;
...
.controller('AutomationDetailsController',  ['$location', '$scope', '$stateParams', 'bngApi','Utils','$sce','$sanitize', '$timeout', '$http','$state','AutomationFilter','AutomationCategories','$filter',
  function($location, $scope, $stateParams, bngApi,Utils,$sce,$sanitize,$timeout,$http,$state,AutomationFilter,AutomationCategories,$filter) {
  var vm = this;
