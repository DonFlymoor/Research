...
singleton Material("van.skin.SKINTEMPLATE")
{
   mapTo = "van.skin.SKINTEMPLATE";
    colorPaletteMap[2] = "vehicles/van/SKINTEMPLATE/SKINTEMPLATE_palette_uv1";
    overlayMap[2] = "vehicles/van/SKINTEMPLATE/SKINTEMPLATE.dds";
