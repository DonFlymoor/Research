...
singleton Material("pigeon.skin.SKINTEMPLATE")
{
   mapTo = "pigeon.skin.SKINTEMPLATE";
    colorPaletteMap[2] = "vehicles/pigeon/SKINTEMPLATE/SKINTEMPLATE_palette_uv1";
    overlayMap[2] = "vehicles/pigeon/SKINTEMPLATE/SKINTEMPLATE.dds";
