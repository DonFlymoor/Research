...
singleton Material("barstow.skin.SKINTEMPLATE")
{
   mapTo = "barstow.skin.SKINTEMPLATE";
    colorPaletteMap[2] = "vehicles/barstow/SKINTEMPLATE/SKINTEMPLATE_palette_uv1";
    overlayMap[2] = "vehicles/barstow/SKINTEMPLATE/SKINTEMPLATE.dds";
