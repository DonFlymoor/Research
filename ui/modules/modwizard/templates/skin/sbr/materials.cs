...
singleton Material("sbr.skin.SKINTEMPLATE")
{
   mapTo = "sbr.skin.SKINTEMPLATE";
    colorPaletteMap[2] = "vehicles/sbr/SKINTEMPLATE/SKINTEMPLATE_palette_uv1";
    overlayMap[2] = "vehicles/sbr/SKINTEMPLATE/SKINTEMPLATE.dds";
