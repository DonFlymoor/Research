...
singleton Material("etk800.skin.SKINTEMPLATE")
{
   mapTo = "etk800.skin.SKINTEMPLATE";
    colorPaletteMap[2] = "vehicles/etk800/SKINTEMPLATE/SKINTEMPLATE_palette_uv1";
    overlayMap[2] = "vehicles/etk800/SKINTEMPLATE/SKINTEMPLATE.dds";
