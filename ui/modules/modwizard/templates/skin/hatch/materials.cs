singleton Material("hatch.skin.SKINTEMPLATE")
{
    mapTo = "hatch.skin.SKINTEMPLATE";
    colorPaletteMap[2] = "vehicles/hatch/SKINTEMPLATE/SKINTEMPLATE_palette_uv1";
    overlayMap[2] = "vehicles/hatch/SKINTEMPLATE/SKINTEMPLATE.dds";
