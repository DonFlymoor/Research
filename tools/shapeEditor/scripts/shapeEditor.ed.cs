...
function ShapeEdSelectWindow::navigate( %this, %address )
{
    ...
    %fullPath = findFirstFileMultiExpr( strreplace(%address, " ", "/") @ "/" @ %filePatterns, 0);
...
function ShapeEdPropWindow::update_onMeshAdded( %this, %meshName )
{
    ...
    // !!!!! DEAD CODE INSIDE : the colision window have been removed
...
function ShapeEditor::autoAddDetails( %this, %dest )
{
    ...
    debug( "Pattern is: " @ %filePatterns );

    %fullPath = findFirstFileMultiExpr( %filePatterns, 0 );
    while ( %fullPath !$= "" )
    {
        %fullPath = makeRelativePath( %fullPath, getMainDotCSDir() );
        ...
        {
            debug( "Found LOD shape file: " @ %fullPath );
