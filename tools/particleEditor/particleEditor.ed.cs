...
{
    debug( "Initializing ParticleEmitterData and ParticleData DataBlocks..." );
...
function ParticleEditor::createParticleList( %this )
{
    ...
    debug( "Found" SPC %emitterCount SPC "emitters and" SPC %particleCount SPC "particles." );
}
...
{
    %tform = Game.getCameraHandler().getEyeTransformF();
    %vec = VectorNormalize( Game.getCameraHandler().getForwardVector() );
