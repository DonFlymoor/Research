  ...
  if drawDebug and currentScenario.nodes and currentScenario.lapConfig then
    ...
    for _, wp in pairs(currentScenario.lapConfig) do
      ...
      if n then
        ...
        debugDrawer:drawText(pp, String(label), ColorF(0,0,0,1))
    ...
    for _, wp in pairs(currentScenario.debugPath) do
      ...
      if lastwpd then
        ...
        debugDrawer:drawSquarePrism(lastwpd.pos:toPoint3F(), wpd.pos:toPoint3F(), Point2F(0.6, lastwpd.radius*2), Point2F(0.6, wpd.radius*2), col)
      end
      lastwpd = wpd
      lastwpdStr = wp
    end
