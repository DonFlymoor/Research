...
local garageLevel = 'levels/garage/main.level.json'
...
local function _start()
  guihooks.trigger('ChangeState', 'garageProto.menu.select')
...
local function onExtensionLoaded()
  log('D', 'nodeStream.onExtensionLoaded', "ui/garage module loaded")
  activate()
end
...
local function onClientStartMission(missionFile)
  if missionFile == garageLevel then
    ...
    ambientSoundIdGeneral = Engine.Audio.createSource('AudioGui', 'event:>UI>Garage>Garage Main')
