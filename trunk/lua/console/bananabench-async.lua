...
function myBenchStep(testVehicle, n)
    ...
    for i=currentObjects + 1, n do
        BeamEngine:spawnObject(i, testVehicle, '', float3(300 * i, 300 * i, 300 * i)) -- this assumes that the object is max. 300 meters high
...
function benchPhysics(vehicles, vehicleMin, vehicleMax)
    ...
    for k,vehicle in pairs(vehicles) do
        ...
        BeamEngine:spawnObject(k, testVehicle, '', float3(300 * k, 300 * k, 300 * k))
        ...
        for n = vehicleMin, vehicleMax, 1 do
            ...
            for dc = 1, 2 do
                local res = t.res[dc]
                Settings.dynamicCollision = (dc == 1)
