...
local function validate(device)
  ...
  device.viscousTorque = device.jbeamData.viscousTorque or (device.parent.torqueData.maxTorque + device.parent.maxRPM * device.parent.inertia * math.pi / 60)
  return true
end
...
local function reset(device)
  ...
  device.viscousCoef = device.jbeamData.viscousCoef or 10 --Nm/rad/s
