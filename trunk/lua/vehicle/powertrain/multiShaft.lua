...
local function calculateInertia(device)
  ...
  device.viscousCoef = device.jbeamData.viscousCoef or (100 * outputInertia)
...
local function reset(device)
  ...
  device.defaultToggle = jbeamData.defaultToggle or false
...
local function new(jbeamData)
  local device = {
    ...
    virtualMassAV = 0,
    isBroken = false,
    availableModes = {"connected", "disconnected"},
    mode = jbeamData.isDisconnected and "disconnected" or "connected",
    defaultToggle = jbeamData.defaultToggle or false,
