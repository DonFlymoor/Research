...
local function restoreOriginalCamera()
  if core_camera then
    ...
    if objId1 ~= nil then
      if scenetree.findObjectById(objId1) ~= nil and obj1OriginalDistance ~= nil then
    ...
    if objId2 ~= nil then
      if scenetree.findObjectById(objId2) ~= nil and obj2OriginalDistance ~= nil then
...
local function onUpdate()
  if objId1 == nil or objId2 == nil or (be:getPlayerVehicleID(0) ~= objId2 and be:getPlayerVehicleID(0) ~= objId1) then return end

  local obj1 = scenetree.findObjectById(objId1)
  local obj2 = scenetree.findObjectById(objId2)

  local playerVehiclePos = be:getPlayerVehicle(0):getPosition()
