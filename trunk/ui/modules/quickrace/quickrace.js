...
.controller('QuickraceController', ['$filter', '$scope', '$state', '$interval', 'bngApi', '$stateParams', 'Aux','QuickraceService', 'VehicleSelectConfig', 'gamepadNav',
  function($filter,  $scope, $state, $interval, bngApi, $stateParams, Aux, QuickraceService, VehicleSelectConfig, gamepadNav) {
