...
singleton Material("pessima.skin.SKINTEMPLATE")
{
   mapTo = "pessima.skin.SKINTEMPLATE";
    colorPaletteMap[2] = "vehicles/pessima/SKINTEMPLATE/SKINTEMPLATE_palette_uv1";
    overlayMap[2] = "vehicles/pessima/SKINTEMPLATE/SKINTEMPLATE.dds";
