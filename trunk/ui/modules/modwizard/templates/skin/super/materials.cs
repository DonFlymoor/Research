...
singleton Material("super.skin.SKINTEMPLATE")
{
   mapTo = "super.skin.SKINTEMPLATE";
    colorPaletteMap[2] = "vehicles/super/SKINTEMPLATE/SKINTEMPLATE_palette_uv1";
    overlayMap[2] = "vehicles/super/SKINTEMPLATE/SKINTEMPLATE.dds";
