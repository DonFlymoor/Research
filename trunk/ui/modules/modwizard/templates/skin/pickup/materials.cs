...
singleton Material("pickup.skin.SKINTEMPLATE")
{
   mapTo = "pickup.skin.SKINTEMPLATE";
    colorPaletteMap[2] = "vehicles/pickup/SKINTEMPLATE/SKINTEMPLATE_palette_uv1";
    overlayMap[2] = "vehicles/pickup/SKINTEMPLATE/SKINTEMPLATE.dds";
