...
.directive('forcedInduction', ['$log', 'bngApi', 'StreamsManager', 'UiUnits', 'Utils', function ($log, bngApi, StreamsManager, UiUnits, Utils) {
  return {
    template: 
        '<object style="width:100%; height:100%; visibility: hidden; box-sizing:border-box; pointer-events: none" type="image/svg+xml" data="modules/apps/forcedinduction/forcedinduction.svg?t=' + Date.now() + '"/>',
    replace: true,
    restrict: 'EA',
