...
.directive('simpleEngineDebug', ['UiUnits', function (UiUnits) {
  return {
    template:
      ...
      $scope.$on('streamsUpdate', function (event, streams) {
        $scope.$evalAsync(function () {
          $scope.streams = streams;
            $scope.display.power = UiUnits.buildString('power', streams.engineInfo[4]*streams.engineInfo[8] * Math.PI/30000 * 1.34102, 2);
            $scope.display.wheelPower = UiUnits.buildString('power', streams.engineInfo[20]/1000 * 1.34102, 2);
