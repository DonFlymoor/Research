...
.directive('simpleDigSpeedo', ['logger', 'StreamsManager', 'UiUnits', function (logger, StreamsManager, UiUnits) {
  return {
    template:
      '<div style="width:100%; height:100%;" class="bngApp" layout="column">' +
        ...
        '</div>' +
        '<small style="text-align:center; color: rgba(255, 255, 255, 0.8); font-size: 0.75em">Wheelspeed</small>' +
      '</div>',
    replace: true,
    restrict: 'EA',
    link: function (scope, element, attrs) {
      ...
      scope.$on('$destroy', function () {
        // logger.App.log('<simple-dig-speedo> destroyed');
