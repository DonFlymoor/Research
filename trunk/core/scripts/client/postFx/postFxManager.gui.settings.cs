...
function PostFXManager::settingsSetEnabled(%this, %bEnablePostFX)
{
    ...
    if ( %bEnablePostFX )
    {
        ...
        debug("% - PostFX Manager - PostFX enabled");
    }
    else
    {
        //Disable all postFX
        ...
        debug("% - PostFX Manager - PostFX disabled");
    }
}
...
function PostFXManager::settingsEffectSetEnabled(%this, %sName, %bEnable)
{
    ...
    {
        %postEffect.enable();
        debug("% - PostFX Manager - " @ %sName @ " enabled");
    }
    else
    {
        %postEffect.disable();
        debug("% - PostFX Manager - " @ %sName @ " disabled");
    }
}
...
function PostFXManager::settingsRefreshAll(%this)
{
    ...
    debug("% - PostFX Manager - GUI values updated.");
}

function PostFXManager::settingsApplyFromPreset(%this)
{
    debug("% - PostFX Manager - Applying from preset");
...
function PostFXManager::settingsApplySSAO(%this)
{
    ...
    //debug("% - PostFX Manager - Settings Saved - SSAO");
...
function PostFXManager::settingsApplyHDR(%this)
{
    ...
    //debug("% - PostFX Manager - Settings Saved - HDR");
}
...
function PostFXManager::settingsApplyLightRays(%this)
{
    ...
    //debug("% - PostFX Manager - Settings Saved - Light Rays");
...
function PostFXManager::settingsApplyDOF(%this)
{
    ...
    //debug("% - PostFX Manager - Settings Saved - DOF");
...
function PostFXManager::settingsApplyAll(%this, %sFrom)
{
    ...
    debug("% - PostFX Manager - All Settings applied to $PostFXManager::Settings");
}
