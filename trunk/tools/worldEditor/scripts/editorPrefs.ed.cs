...
EditorSettings.setDefaultValue(  "currentEditor",           "WorldEditorInspectorPlugin" );
EditorSettings.setDefaultValue(  "newLevelFile",            "levels/smallgrid/smallgrid.mis" );
EditorSettings.setDefaultValue(  "autoSave",                "0"    );
EditorSettings.setDefaultValue(  "autoSaveInterval",        "90"   );
...
EditorSettings.setDefaultValue(  "mouseFineRotateScalar",       "0.02"             );
EditorSettings.setDefaultValue(  "mouseFineScaleScalar",        "0.02"             );
...
{
    echo("Reading world editor settings...");
    ...
    EWorldEditor.autoSave                  = EditorSettings.value( "autoSave" );
    EWorldEditor.autoSaveInterval          = EditorSettings.value( "autoSaveInterval" );
    ...
    GlobalGizmoProfile.fineRotateScalar    = EditorSettings.value("mouseFineRotateScalar");          //$pref::WorldEditor::mouseFineRotateScalar;
    GlobalGizmoProfile.fineScaleScalar     = EditorSettings.value("mouseFineScaleScalar");           //$pref::WorldEditor::mouseFineScaleScalar;
...
{
    echo("Writing world editor settings...");
    scheduleAutoSave();
    ...
    EditorSettings.setvalue( "autoSave",               EWorldEditor.autoSave );
    EditorSettings.setvalue( "autoSaveInterval",       EWorldEditor.autoSaveInterval );
    ...
    EditorSettings.setValue( "mouseFineRotateScalar",      GlobalGizmoProfile.fineRotateScalar );     //$Pref::WorldEditor::mouseFineRotateScalar
    EditorSettings.setValue( "mouseFineScaleScalar",       GlobalGizmoProfile.fineScaleScalar );      //$Pref::WorldEditor::mouseFineScaleScalar
