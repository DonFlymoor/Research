...
singleton GuiControlProfile( GuiInspectorTextEditMonospaceProfile : GuiInspectorTextEditProfile )
{
...
singleton GuiControlProfile( GuiInspectorFieldProfileMono : GuiInspectorFieldProfile )
{
    fontType = "Courier New Bold";
    // for debugging purposes:
    //fillColor = "255 0 0";
