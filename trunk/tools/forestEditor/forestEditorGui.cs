...
function ForestEditorGui::onSelect( %this )
{
     // Inform the camera
...
function ForestEditorGui::onClearSelection( %this )
{
    // Inform the camera
    EditorOrbitCameraSelectChange(%this.getSelectionSize(), %this.getSelectionCentroid());
...
function ForestEditorGui::onSelectionCentroidChanged( %this )
{
    // Inform the camera
    EditorOrbitCameraSelectChange(%this.getSelectionSize(), %this.getSelectionCentroid());
...
function ForestEditorGui::newBrush( %this )
{
    ...
    ForestEditBrushTree.addSelectionItemId( %item );
...
function ForestEditorGui::newMesh( %this )
{
    ...
    if ( isObject( %name ) )
    {
        ...
        ForestEditMeshTree.addSelectionItemId( %item );

        ForestDataManager.setDirty( %name, getMissionPath() @ "art/forest/managedItemData.cs" );
...
function ForestEditorGui::okDeleteMesh( %this, %mesh )
{
    ...
    ForestDataManager.removeObjectFromFile( %mesh, getMissionPath() @ "art/forest/managedItemData.cs" );
...
function ForestEditMeshTree::onDoubleClick( %this )
{
    ...
    //ForestDataManager.setDirty( %element, getMissionPath() @ "art/forest/brushes.cs" );
...
function ForestEditorInspector::inspect( %this, %obj )
{
    ...
    switch$ ( %class )
    {
        ...
        case "TSForestItemData":
            %this.groupFilters = "+Media,+Wind,+ObjectAnnotation";
