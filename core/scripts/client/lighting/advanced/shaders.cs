...
new GFXStateBlockData( AL_VectorLightState )
{
    ...
    samplerStates[1] = SamplerClampPoint;  // G-buffer
    ...
    samplerStates[5] = SamplerClampPoint;  // G-buffer
    samplerStates[6] = SamplerClampPoint;  // G-buffer
...
new CustomMaterial( AL_VectorLightMaterial )
{
    ...
    sampler["prePassBuffer"] = "#prepass[RT0]";
    sampler["prePassDepthBuffer"] = "#prepass[Depth]";
...
new GFXStateBlockData( AL_ConvexLightState )
{
    ...
    zEnable = true;
    zWriteEnable = false;
    zFunc = $Scene::useReversedDepthBuffer ? GFXCmpLessEqual : GFXCmpGreaterEqual;
